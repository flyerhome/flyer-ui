...
<template>
  <div style="position: relative;padding: 5px;z-index: 999;width:100%;height: 100%;min-height: 500px; background: #bdedf6;display: flex;justify-content: start;align-items: center;flex-direction: column">
    ...
    <audio ref="videoRef" @loadedmetadata="resumePlayTime" :controls="true" style="background: unset;height:60px;margin-top: 10px" :style="{width: widthRate + '%'}"  @mouseover="()=> controls = true" @mouseleave="()=> controls = false">
    </audio>
    <div :style="{width: widthRate + '%',marginTop: '10px'}">
      <a-button type="primary" :style="{width: 'calc(30% - 10px)',marginRight: '10px'}" @click="markStart">标记起点</a-button>
      <a-input v-model:value="startValue" style="width: calc(20% - 10px);margin-right:10px;"></a-input>
      <a-button type="primary" :style="{width: 'calc(30% - 10px)',marginRight: '10px'}" @click="markEnd">标记终点</a-button>
      <a-input v-model:value="endValue" style="width: calc(20% - 10px);margin-right:10px;"></a-input>
    </div>
    <div :style="{width: widthRate + '%',marginTop: '10px'}">
      <a-input v-model:value="peopleName" style="width: calc(100% - 10px);margin-right:10px;margin-bottom: 10px;" placeholder="人物命名"></a-input>
      <a-input v-model:value="wavName" style="width: calc(100% - 10px);margin-right:10px;margin-bottom: 10px;" placeholder="语音命名"></a-input>
      <a-input v-model:value="textContent" style="width: calc(100% - 10px);margin-right:10px;margin-bottom: 10px;" placeholder="语音文本"></a-input>
